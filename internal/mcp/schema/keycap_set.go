...
type KeycapSetSummary struct {
	...
	Visibility         *string  `json:"visibility,omitempty" jsonschema:"who can read this keycap set, set on the keycap set itself rather than derived from its kits; one of \"public\", \"authenticated\", \"private\"; omitted if the caller doesn't own this set"`
}
