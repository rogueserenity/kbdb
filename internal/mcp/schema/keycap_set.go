...
type KeycapSetSummary struct {
	...
	Visibility         *string  `json:"visibility,omitempty" jsonschema:"who can read this keycap set; one of \"public\", \"authenticated\", \"private\"; omitted if the caller doesn't own this set"`
}
