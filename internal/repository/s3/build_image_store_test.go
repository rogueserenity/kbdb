...
func (s *BuildImageStoreSuite) TestPresignGetBuildImage_Succeeds() {
	...
	url, expiresAt, err := s.store.PresignGetBuildImage(s.T().Context(), "builds/alice/b1/images/img1")
...
func (s *BuildImageStoreSuite) TestPresignGetBuildImage_CapsExpiryToCredentialLifetime() {
	...
	_, _, err := s.store.PresignGetBuildImage(s.T().Context(), "builds/alice/b1/images/img1")

	s.Require().NoError(err)
}

func (s *BuildImageStoreSuite) TestPresignGetBuildImage_StaticCredentials_UsesFixedTTL() {
...
func (s *BuildImageStoreSuite) TestPresignGetBuildImage_CredentialsInsideMargin_StillSignsForWhatIsLeft() {
...
func (s *BuildImageStoreSuite) TestPresignGetBuildImage_CredentialsAlreadyExpired_Fails() {
...
func (s *BuildImageStoreSuite) TestPresignGetBuildImage_SDKError_Propagates() {
	...
	url, _, err := s.store.PresignGetBuildImage(s.T().Context(), "builds/alice/b1/images/img1")
